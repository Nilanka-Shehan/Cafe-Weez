...
const Login = () => {
  ...
  const [hasAccess, role, isRoleCheckLoading, isError, refetch] =
    useRoleCheck(allowedRoles);
  ...
  const handleNavigation = () => {
    switch (role) {
      case "admin":
        navigate("/admin-dashboard/order-management-dashboard");
        break;
      case "user":
        navigate("/customer");
        break;
  ...
  if (isError) {
    return (
      <div>Error occurred while checking roles. Please try again later.</div>
    );
  }
